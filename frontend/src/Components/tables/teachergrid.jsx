 ...
 * This is a pure data processing function (frontend logic)
 */
const getTeacherAvailabilityGrid = (
  ...
  // Get teacher's schedule directly from teacherSchedules (data received from parent)
 ...
 * This component is purely presentation and data calculation based on props.
 */
